...
import org.numahop.numahop.domain.multilotsdelivery.QMultiLotsDelivery;
...
public class MultiLotsDeliveryRepositoryImpl implements MultiLotsDeliveryRepositoryCustom {
	...
	public Page<MultiLotsDelivery> search(final String search, final List<String> libraries,
			...
			final List<String> providers, final List<Delivery.DeliveryStatus> status, final LocalDate dateFrom,
			final LocalDate dateTo, final List<WorkflowStateKey> docUnitStates, final Pageable pageable) {
		...
		// UD
		// appendDocUnitFilter(docUnitPgcnId, docUnitStates,
		// qDelivery).ifPresent(builder::and);
	...
	// final QWorkflowModelState qWorkflowModelState =
	// QWorkflowModelState.workflowModelState;
	// final QDocUnit qDocUnit = QDocUnit.docUnit;
	// final QDigitalDocument qDigitalDocument = QDigitalDocument.digitalDocument;
	// final QDeliveredDocument qDeliveredDocument =
	// QDeliveredDocument.deliveredDocument;
	//
