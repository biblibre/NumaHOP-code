...
/**
 * Retranscrit une chaîne spécifique ISO 8601 approchant en ISO 8601 valide. Ex : 185X
 * 186X -> 1850 / 1869 Ex : 19XX -> 1900 Ex : 23/10/2017 -> 2017-10-23
 *
...
public final class DateIso8601Util {
	...
	/**
	 * Transformation d'une date au format pseudo ISO-8601 issue de l'importation vers une
	 * date au format ISO-8601 valide
	 * @param date
	 * @return
	 */
