...
/**
 * Utilitaire pour tarer (detarer) un dossier en conservant son arborescence ou non.
 *
...
public class TarUtils {
	...
	/**
	 * Construction du tar en conservant la structure du repertoire racine. Pour tout
	 * archiver à plat, laisser basePath à null.
	 * @param name tar name
	 * @param basePath root
	 * @param files
	 * @throws IOException
	...
	private static void addToArchiveCompression(final TarArchiveOutputStream out, final File file, final String dir)
			throws IOException {
