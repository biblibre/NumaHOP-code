package org.numahop.numahop.service.ftpconfiguration.ui;
...
import org.numahop.numahop.service.ftpconfiguration.mapper.FTPConfigurationMapper;
import org.numahop.numahop.service.ftpconfiguration.mapper.SimpleFTPConfigurationMapper;
import org.numahop.numahop.service.ftpconfiguration.mapper.UIFTPConfigurationMapper;
...
public class UIFTPConfigurationService {
	...
	public UIFTPConfigurationService(final FTPConfigurationService ftpConfigurationService,
			final ProjectService projectService, final UIFTPConfigurationMapper uiFTPConfigurationMapper) {
	...
	public FTPConfigurationDTO create(FTPConfigurationDTO ftpConfigurationDTO) throws PgcnTechnicalException {
		...
		return FTPConfigurationMapper.INSTANCE
			.ftpConfigurationToFTPConfigurationDTO(ftpConfigurationService.save(ftpConfiguration));
	}
