...
public class MailboxConfigurationService {
	...
	@Autowired
	public MailboxConfigurationService(final MailboxConfigurationRepository mailboxConfigurationRepository,
	...
	@Transactional(readOnly = true)
	public List<MailboxConfigurationDTO> search(final String search, final List<String> libraries,
	...
	@Transactional
	public MailboxConfiguration save(final MailboxConfiguration conf)
	...
	private void setDefaultValues(final MailboxConfiguration conf) throws PgcnTechnicalException {
		...
		// Sinon on reprend le mot de passe existant
			...
			final String currentPassword = mailboxConfigurationRepository
				.findPasswordByIdentifier(conf.getIdentifier());
