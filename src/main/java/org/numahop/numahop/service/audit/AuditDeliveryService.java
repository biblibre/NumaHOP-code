...
import org.numahop.numahop.repository.audit.AuditDeliveryRepository;
...
public class AuditDeliveryService {
	...
	@Autowired
	public AuditDeliveryService(final AuditDeliveryRepository auditDeliveryRepository,
	...
	public List<AuditDeliveryRevisionDTO> getRevisions(final LocalDate fromDate, final List<String> libraries,
	...
	private List<AuditDeliveryRevisionDTO> updateRevisions(final List<AuditDeliveryRevisionDTO> revisions,
		...
		final List<String> deliveryIds = revisions.stream()
			.map(AuditDeliveryRevisionDTO::getIdentifier)
