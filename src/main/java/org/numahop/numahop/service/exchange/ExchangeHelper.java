...
public class ExchangeHelper {
	 ...
	 * Calcule le produit cartésien des listes passées en paramètres
	 * <p>
	 * Par ex.: lists = { 100 => ["a", "b"], 200 => ["c"] } return = [ { 100 => "a", 200
	 * => "c" }, { 100 => "b", 200 => "c" } ]
	 * @param lists
	 * @param <K>
	 * @param <T>
	...
	/**
	 * Déduplique les bindings par rapport à une liste de clés Chaque combinaison de
	 * valeurs issues des variables sera unique à la sortie de distinctBindings
	 * @param bindings
	 * @param variables
	 * @return
	 */
	public static List<Map<String, Object>> distinctBindings(List<Map<String, Object>> bindings,
			List<String> variables) {
		final List<Map<String, Object>> distinctBindings = new ArrayList<>();

		for (final Map<String, Object> binding : bindings) {
			// Filtrage des bindings par rapport à la liste de marcKeys passés en
			// paramètre
