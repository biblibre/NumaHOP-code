...
public class EadCParser {
	...
	/**
	 * Créé une copie de c, avec les même attributs que l'original, mais sans sa
	 * hiérarchie
	 * @param c
	 * @return
	 */
	...
	/**
	 * Recherche des valeurs de fullField dans l'objet c ou dans l'entête EAD Si aucune
	 * valeur n'est trouvée dans c, on recherche dans son parent
	 * @param c
	 * @param fullField si le champ commence par "all:", recherche des valeur dans toute
	 * la hiérarchie des éléments C, sans se limiter au premier niveau renseigné
	 * @return
	 */
	 ...
	 * @param c
	 * @param fullField
	 * @param allFlag recherche des valeur dans toute la hiérarchie des éléments C, sans
	 * se limiter au premier niveau renseigné
	 * @return
	 */
	...
	/**
	 * Appelle getObjectValues, et renvoie: - null si aucune valeur n'a été trouvée -
	 * l'objet d'indice 0 si la liste ne contient qu'un élément - la liste elle même sinon
	 * @param o
	 * @param fullField
	 * @return
	 */
		...
		try {
			...
			if (PropertyUtils.isReadable(o, field)) {
				...
				if (value != null) {
					...
					// extraction des valeurs de JAXBElements, filtrage des valeurs
					// valides
	 ...
	 */
	public static List<?> getNextValues(final Object o)
		...
		// Classe possédant une propriété content (content étant une liste d'éléments
		// sérialisables: texte, jaxbelement
	...
	/**
	 * Recherche les valeurs de subField dans les sous-object field pour chaque élément de
	 * objects
	 * @param objects
	 * @param field
	 * @param subField
	...
	/**
	 * Recherche les valeurs de fullField dans les sous-object field pour chaque élément
	 * de objects
	 * @param objects
	 * @param fullField
	 * @return
	...
	private void parseC(final C c) {
		final List<C> cChildren = c.getTheadAndC()
			.stream()
