package org.numahop.numahop.service.exchange.z3950;

import org.numahop.numahop.domain.administration.exchange.z3950.DataFormat;
...
import org.numahop.numahop.service.administration.mapper.Z3950ServerMapper;
...
public class Z3950Service {
	...
	// MOCK à garder...
	// final String xml =
	// "<?xml version=\"1.0\" encoding=\"UTF-8\"?><marcxml:collection
	// xmlns:marcxml=\"http://www.loc.gov/MARC21/slim\">\r\n <marcxml:record>\r\n
	// <marcxml:leader>01096cam 2200265 450 </marcxml:leader>\r\n
	// <marcxml:controlfield
	// tag=\"001\">FRBNF437004190000002</marcxml:controlfield>\r\n
	// <marcxml:controlfield
	// tag=\"003\">http://catalogue.bnf.fr/ark:/12148/cb43700419m</marcxml:controlfield>\r\n
	// <marcxml:datafield tag=\"010\"
	// ind1=\" \" ind2=\" \">\r\n <marcxml:subfield
	// code=\"a\">978-2-35287-505-5</marcxml:subfield>\r\n <marcxml:subfield
	// code=\"b\">rel.</marcxml:subfield>\r\n <marcxml:subfield code=\"d\">12
	// EUR</marcxml:subfield>\r\n </marcxml:datafield>\r\n <marcxml:datafield
	// tag=\"020\" ind1=\" \" ind2=\" \">\r\n <marcxml:subfield
	...
	// <marcxml:subfield code=\"a\">20131028d2013 m y0frey50
	// ba</marcxml:subfield>\r\n </marcxml:datafield>\r\n <marcxml:datafield
	// tag=\"101\"
	// ind1=\"0\" ind2=\" \">\r\n <marcxml:subfield
	// code=\"a\">fre</marcxml:subfield>\r\n </marcxml:datafield>\r\n
	// <marcxml:datafield tag=\"102\"
	// ind1=\" \" ind2=\" \">\r\n <marcxml:subfield
	// code=\"a\">FR</marcxml:subfield>\r\n </marcxml:datafield>\r\n
	// <marcxml:datafield tag=\"105\"
	// ind1=\" \" ind2=\" \">\r\n <marcxml:subfield code=\"a\"> z 00 a
	// </marcxml:subfield>\r\n </marcxml:datafield>\r\n <marcxml:datafield
	// tag=\"106\"
	// ind1=\" \" ind2=\" \">\r\n <marcxml:subfield
	// code=\"a\">r</marcxml:subfield>\r\n </marcxml:datafield>\r\n
	// <marcxml:datafield tag=\"200\"
	// ind1=\"1\" ind2=\" \">\r\n <marcxml:subfield code=\"a\"> Les trois
	// mousquetaires</marcxml:subfield>\r\n <marcxml:subfield code=\"b\">Texte
	// imprim\u00E9</marcxml:subfield>\r\n <marcxml:subfield code=\"f\">Alexandre
	// Dumas</marcxml:subfield>\r\n </marcxml:datafield>\r\n
	// <marcxml:datafield tag=\"210\" ind1=\" \" ind2=\" \">\r\n <marcxml:subfield
	// code=\"a\">Paris</marcxml:subfield>\r\n <marcxml:subfield
	// code=\"c\">[Archipoche]</marcxml:subfield>\r\n <marcxml:subfield
	// code=\"d\">cop. 2013</marcxml:subfield>\r\n <marcxml:subfield
	// code=\"e\">59-Villeneuve-d'Ascq</marcxml:subfield>\r\n <marcxml:subfield
	// code=\"g\">Impr. Imago</marcxml:subfield>\r\n </marcxml:datafield>\r\n
	// <marcxml:datafield tag=\"215\" ind1=\" \" ind2=\" \">\r\n <marcxml:subfield
	// code=\"a\">1 vol. (947 p.)</marcxml:subfield>\r\n <marcxml:subfield
	// code=\"c\">jaquette ill. en coul.</marcxml:subfield>\r\n <marcxml:subfield
	// code=\"d\">16 cm</marcxml:subfield>\r\n </marcxml:datafield>\r\n
	// <marcxml:datafield tag=\"225\" ind1=\"|\" ind2=\" \">\r\n <marcxml:subfield
	// code=\"a\"> La biblioth\u00E8que du
	// collectionneur</marcxml:subfield>\r\n <marcxml:subfield
	// code=\"v\">21</marcxml:subfield>\r\n </marcxml:datafield>\r\n
	// <marcxml:datafield
	// tag=\"410\" ind1=\" \" ind2=\"0\">\r\n <marcxml:subfield
	// code=\"0\">42537932</marcxml:subfield>\r\n <marcxml:subfield code=\"t\"> La
	...
	public Page<Z3950RecordDTO> search(final Map<String, String> fields, final List<String> serverIdentifiers,
			final int page, final int size) throws PgcnBusinessException {
		...
		for (final Z3950Server z3950Server : servers) {
			try (Connection connection = createConnection(z3950Server)) {
				...
				LOG.debug("Le serveur {} ({}) a renvoyé {} résultat(s)", z3950Server.getName(),
						z3950Server.getIdentifier(), totalCount);
				...
				final PgcnError.Builder builder = new PgcnError.Builder();
				throw new PgcnBusinessException(builder.reinit()
					.setCode(PgcnErrorCode.Z3950_SEARCH_FAILURE)
					.addComplement(e.getMessage())
					.build());
			}
		}
	 ...
	 * @param z3950Server le serveur Z39.50
	 * @return
	...
	private Query createQuery(final Map<String, String> fields, final DataEncoding dataEncoding) {
		...
		for (final Entry<String, String> entry : fields.entrySet()) {
			...
			if (charConverter != null) {
				// Conversion de la chaîne UTF-8 à recherche dans le format attendu par le
				// serveur Z39.50
	 ...
	 * @return
	 */
	private Optional<org.marc4j.marc.Record> convertToMarcRecord(final Record yazRecord,
