package org.numahop.numahop.service.project;
...
public class ProjectService {
	...
	public ProjectService(final DocUnitService docUnitService, final ImportReportService importReportService,
			final EsProjectService esProjectService, final ProjectRepository projectRepository) {
	...
	public void delete(final Collection<Project> projects) throws PgcnListValidationException {
		...
		final List<Project> invalidObjects = projects.stream()
			.filter(pj -> !pj.getErrors().isEmpty())
	 ...
	 * @param identifier l'identifiant d'un project
	 * @throws PgcnValidationException si la suppression du projet échoue
	 */
	@Transactional
	...
	@Transactional(readOnly = true)
	public List<Project> findProjectsForWidget(final LocalDate fromDate, final List<String> libraries,
	 ...
	 */
	@Transactional(readOnly = true)
	public Page<Project> search(final String search, final String initiale, final List<String> libraries,
			final List<Project.ProjectStatus> status, final List<String> providers, final boolean active,
	 ...
	 */
	@Transactional(readOnly = true)
	public List<Project> loadCreatedProjects(final String searchProject, final String initiale,
			final List<String> libraries, final List<Project.ProjectStatus> statuses, final boolean active) {
	 ...
	 */
	@Transactional(readOnly = true)
	public Page<Project> findAllForStatistics(final String search, final List<String> libraries,
	...
	public List<Map<String, Object>> getProjectGroupByStatus(final List<String> libraries) {
		final List<Object[]> results = CollectionUtils.isNotEmpty(libraries)
				? projectRepository.getProjectGroupByStatus(libraries) : projectRepository.getProjectGroupByStatus(); // status,
																														// count
