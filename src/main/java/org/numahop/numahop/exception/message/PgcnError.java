...
/**
 * Classe d'erreur permettant de fournir un code d'erreur à l'IHM ainsi qu'un message
 * d'erreur affiché dans la log. Il est également possible de fournir des compléments qui
 * pourront être injectés dans le message à destination de l'utilisateur.
 *
 * @author David
 */
public final class PgcnError {
	...
	private PgcnError(final PgcnErrorCode code, final String field, final String message,
			final List<String> complements, final Object additionnalComplements) {
		super();
		this.code = code;
		this.field = field;
