...
public class NotificationDTO {
	...
	public enum NotificationCode {
		...
		INDEX_BORROWER_TERMINATED, INDEX_BORROWER_ERROR, INDEX_CATALOG_TERMINATED, INDEX_CATALOG_ERROR,
		INDEX_CONCEPTS_TERMINATED, INDEX_CONCEPTS_ERROR, SYNCHRO_BORROWERS_TERMINATED, SYNCHRO_BORROWERS_ERROR,
		SYNCHRO_CATALOG_TERMINATED, SYNCHRO_CATALOG_ERROR, SYNCHRO_CONCEPTS_TERMINATED, SYNCHRO_CONCEPTS_ERROR;
