...
public class DocPropertyTypeController extends AbstractRestController {
	...
	@Autowired
	public DocPropertyTypeController(final DocPropertyTypeService docPropertyTypeService,
			final UIDocPropertyTypeService uiDocPropertyTypeService) {
		super();
	...
	@RequestMapping(method = RequestMethod.GET, params = { "dto", "supertype" },
	...
	public ResponseEntity<DocPropertyType> create(@RequestBody final DocPropertyType type)
	...
	@Timed
	@RolesAllowed({ DOC_UNIT_HAB5 })
	public ResponseEntity<DocPropertyType> update(@RequestBody final DocPropertyType type)
			throws PgcnValidationException {
		final DocPropertyType savedType = docPropertyTypeService.save(type);
