package org.numahop.numahop.web.rest.lot.security;
...
public final class AuthorizationConstants {
	...
	/**
	 * Habilitation à la gestion des lots : Contrôler après réception et comptage
	 * (physique ou numérique) : valider, rejeter…
	 */
