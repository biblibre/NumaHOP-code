package org.numahop.numahop.web.rest.lot;

import static org.numahop.numahop.web.rest.document.security.AuthorizationConstants.*;
import static org.numahop.numahop.web.rest.lot.security.AuthorizationConstants.*;
...
import org.numahop.numahop.domain.dto.lot.ResultAdminLotDTO;
...
import org.numahop.numahop.service.lot.ui.UILotService;
