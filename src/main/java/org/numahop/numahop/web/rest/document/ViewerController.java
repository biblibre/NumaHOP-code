...
public class ViewerController extends AbstractRestController {
	...
	/*
	 * Precos: Modèle d'URI Collection {scheme}://{host}/{prefix}/collection/{name}
	 * Manifest {scheme}://{host}/{prefix}/{identifier}/manifest Sequence
	 * {scheme}://{host}/{prefix}/{identifier}/sequence/{name} Canvas
	 * {scheme}://{host}/{prefix}/{identifier}/canvas/{name} Annotation
	 * {scheme}://{host}/{prefix}/{identifier}/annotation/{name} AnnotationList
	 * {scheme}://{host}/{prefix}/{identifier}/list/{name} Range
	 * {scheme}://{host}/{prefix}/{identifier}/range/{name} Layer
	 * {scheme}://{host}/{prefix}/{identifier}/layer/{name} Content
	...
	public ResponseEntity<?> getManifestViewer(final HttpServletRequest request, final HttpServletResponse response,
	...
	@RequestMapping(value = "/sample/{identifier}/manifest", method = RequestMethod.GET,
			produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	@RolesAllowed(CHECK_HAB3)
	public ResponseEntity<?> getSampledManifestViewer(final HttpServletRequest request,
			final HttpServletResponse response, @PathVariable final String identifier) throws PgcnTechnicalException {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/{identifier}/{pageNumber}/info.json", method = RequestMethod.GET,
			produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	@RolesAllowed(CHECK_HAB3)
	public ResponseEntity<Map<String, Object>> getFileInfos(final HttpServletRequest request,
			final HttpServletResponse response, @PathVariable final String identifier,
	 ...
	 */
	@RequestMapping(value = "/{identifier}/{pageNumber}/full/{dim1}/{dim2}/default.jpg", method = RequestMethod.GET,
			produces = MediaType.IMAGE_JPEG_VALUE)
	@Timed
	@RolesAllowed(CHECK_HAB3)
	public ResponseEntity<?> getDefault(final HttpServletRequest request, final HttpServletResponse response,
			@PathVariable final String identifier, @PathVariable final int pageNumber, @PathVariable final String dim1,
		...
		if (dims.length > 1 && StringUtils.isNotBlank(dims[1]) && StringUtils.isNumeric(dims[1])) {
	 ...
	 * @throws PgcnTechnicalException
	 */
	@RequestMapping(value = "/{identifier}/{pageNumber}/{args1}/{args2}/{test}/default.jpg", method = RequestMethod.GET,
			produces = MediaType.IMAGE_JPEG_VALUE)
	@Timed
	@RolesAllowed(CHECK_HAB3)
	public ResponseEntity<?> getZooms(final HttpServletRequest request, final HttpServletResponse response,
			@PathVariable final String identifier, @PathVariable final int pageNumber, @PathVariable final String args1,
	...
	@Timed
	@RolesAllowed(CHECK_HAB3)
	public ResponseEntity<?> getThumbnail(final HttpServletRequest request, final HttpServletResponse response,
			@PathVariable final String identifier, @PathVariable final int pageNumber) throws PgcnTechnicalException {
	...
	@Timed
	@RolesAllowed(CHECK_HAB3)
	public ResponseEntity<?> getMaster(final HttpServletRequest request, final HttpServletResponse response,
			@PathVariable final String identifier, @PathVariable final int pageNumber) throws PgcnTechnicalException {
	...
	@Timed
	@RolesAllowed(CHECK_HAB3)
	public ResponseEntity<?> getPdfMaster(final HttpServletRequest request, final HttpServletResponse response,
			@PathVariable final String identifier) throws PgcnTechnicalException {
	...
	@Timed
	@RolesAllowed(CHECK_HAB3)
	public ResponseEntity<?> getTableOfContent(final HttpServletRequest request, final HttpServletResponse response,
			@PathVariable final String identifier) throws PgcnTechnicalException {
