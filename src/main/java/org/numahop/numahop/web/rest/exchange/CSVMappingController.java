...
import static org.numahop.numahop.web.rest.administration.security.AuthorizationConstants.ADMINISTRATION_LIB;
...
public class CSVMappingController extends AbstractRestController {
	...
	@Autowired
	public CSVMappingController(final CSVMappingService mappingService,
	...
	public ResponseEntity<Collection<CSVMappingDTO>> findAll(final HttpServletRequest request) {
		...
		mappingDTOS = libraryAccesssHelper.filterObjectsByLibrary(request, mappingDTOS,
				dto -> dto.getLibrary().getIdentifier(), ADMINISTRATION_LIB);
		// Réponse
	...
	@Timed
	@RolesAllowed(MAP_HAB0)
	public ResponseEntity<Set<CSVMappingDTO>> findByLibrary(final HttpServletRequest request,
	...
	@Timed
	@RolesAllowed(MAP_HAB1)
	public ResponseEntity<CSVMapping> duplicateMapping(final HttpServletRequest request, @PathVariable final String id,
