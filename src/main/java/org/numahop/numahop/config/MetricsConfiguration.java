...
public class MetricsConfiguration extends MetricsConfigurerAdapter {
	...
	public MetricsConfiguration(final CacheManager cacheManager) {
		// On injecte juste le cacheManager ici pour qu'il soit créé avant et que les
		// métrics de cache fonctionnent...
	}
	...
	public void init() {
		...
		if (hikariDataSource != null) {
			...
			// remove the factory created by HikariDataSourceMetricsPostProcessor until
			// JHipster migrate to Micrometer
