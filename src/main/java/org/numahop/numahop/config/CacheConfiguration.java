...
public class CacheConfiguration {
	...
	public CacheConfiguration(final Environment environment) {
		this.jcacheConfiguration = Eh107Configuration
			.fromEhcacheCacheConfiguration(CacheConfigurationBuilder
				.newCacheConfigurationBuilder(Object.class, Object.class,
						ResourcePoolsBuilder
							.heap(environment.getProperty("cache.ehcache.max-entries", Long.class, 1000L)))
				.withExpiry(ExpiryPolicyBuilder.timeToLiveExpiration(Duration
					.ofSeconds(environment.getProperty("cache.ehcache.time-to-live-seconds", Long.class, 3600L))))
				.build());
