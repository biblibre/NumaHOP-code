...
public class ScriptEngineConfiguration {
	...
	public ScriptEngine getGroovyScriptEngine() {
		...
		// constant types
		secure.setAllowedConstantTypesClasses(List.of(Boolean.TYPE, Character.TYPE, Integer.TYPE, char[].class,
				int[].class, Boolean.class, Character.class, Object.class, String.class, String[].class,
				// Classes marc4j
				ControlField.class, DataField.class, Leader.class, Record.class, Subfield.class, VariableField.class));
		// receivers
