...
/**
 * Simple time-limited cache for login tokens, necessary to avoid concurrent requests
 * invalidating one another. It uses a {@link java.util.LinkedHashMap} to keep the tokens
 * in order of expiration. During access any entries which have expired are automatically
 * purged.
 */
