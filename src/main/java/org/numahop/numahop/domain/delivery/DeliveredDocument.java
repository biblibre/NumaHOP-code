...
/**
 * Gestion de la livraison d'un document. Cette classe fait le lien entre la livraison et
 * le document livré, et ajoute certaines informations sur la livraison du document
 */
@Entity
