 ...
 * sophisticated linking between a div element and content files representing that div, be
 * they text, image, audio, or video files. An area element can link a div to a point
 * within a file, to a one-dimension segment of a file (e.g., text segment, image line,
 * audio/video clip), or a two-dimensional section of a file (e.g, subsection of an image,
 * or a subsection of the video display of a video file. The area element has no content;
 * all information is recorded within its various attributes.
 * <p>
