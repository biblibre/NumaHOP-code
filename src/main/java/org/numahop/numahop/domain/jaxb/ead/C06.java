...
/**
 * <p>
 * Classe Java pour c06 complex type.
 * <p>
...
@XmlType(name = "c06", propOrder = { "head", "did", "mDescFull", "theadAndC07" })
public class C06 {
	...
	@XmlElements({ @XmlElement(name = "thead", type = Thead.class), @XmlElement(name = "c07", type = C07.class) })
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the theadAndC07
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Thead } {@link C07
	 * }
	 */
	public List<Object> getTheadAndC07() {
		if (theadAndC07 == null) {
			theadAndC07 = new ArrayList<>();
		}
