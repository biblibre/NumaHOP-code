 ...
 * interface generated in the org.numahop.numahop.domain.jaxb.rdf package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _Description_QNAME = new QName("http://www.w3.org/1999/02/22-rdf-syntax-ns#",
			"Description");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema
	 * derived classes for package: org.numahop.numahop.domain.jaxb.rdf
	 */
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link DescriptionType
	 * }{@code >}}
	 */
