...
/**
 * Présentation du service versant responsable du versement ou du dépét du fonds dans le
 * systéme d'archivage électronique du CINES.
 * <p>
...
@XmlType(name = "ServiceVersantType", propOrder = { "nomSV", "datesSV", "historiqueSV", "relationSvProd", "notesSV" })
public class ServiceVersantType {
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the notesSV
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
