...
@XmlType(name = "FichMetaDescriptionType", propOrder = { "compression", "encodage", "formatFichier", "nomFichier",
		"empreinteOri", "noteFichier", "structureFichier" })
public class FichMetaDescriptionType {
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the encodage
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the nomFichier
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the noteFichier
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
