...
public class WorkflowProfileActivityDTO implements Comparable<WorkflowProfileActivityDTO> {
	...
	static {
		Ordering<WorkflowProfileActivityDTO> orderLib = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowProfileActivityDTO::getLibraryName);
		Ordering<WorkflowProfileActivityDTO> orderRole = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowProfileActivityDTO::getRoleLabel);
		Ordering<WorkflowProfileActivityDTO> orderPj = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowProfileActivityDTO::getProjectName);
		Ordering<WorkflowProfileActivityDTO> orderLot = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowProfileActivityDTO::getLotLabel);
		Ordering<WorkflowProfileActivityDTO> orderDoc = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowProfileActivityDTO::getDocPgcnId);
