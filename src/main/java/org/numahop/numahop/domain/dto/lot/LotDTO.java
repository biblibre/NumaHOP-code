...
public class LotDTO extends AbstractVersionedDTO {
	...
	public LotDTO(final String identifier, final String label, final String code, final String type,
			final String description, final Boolean active, final String status, final String condNotes,
			final String numNotes, final String requiredFormat, final Date deliveryDateForseen, final Date realEndDate,
			final ProjectDTO project, final Set<SimpleDocUnitDTO> docUnits,
			...
			final String requiredResolution, final String requiredColorspace,
	...
	public static final class Builder {
		...
		public LotDTO build() {
			return new LotDTO(identifier, label, code, type, description, active, status, condNotes, numNotes,
					requiredFormat, deliveryDateForseen, realEndDate, project, docUnits, activeFTPConfiguration,
					activeExportFTPConfiguration, activeCheckConfiguration, activeFormatConfiguration, collectionIA,
					planClassementPAC, provider, requiredTypeCompression, requiredTauxCompression, requiredResolution,
					requiredColorspace, omekaConfiguration, omekaCollection, omekaItem, activeOcrLanguage,
