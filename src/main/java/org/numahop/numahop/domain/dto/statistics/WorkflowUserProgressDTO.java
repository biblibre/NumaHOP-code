...
public class WorkflowUserProgressDTO implements Comparable<WorkflowUserProgressDTO> {
	...
	static {
		final Ordering<WorkflowUserProgressDTO> orderLib = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowUserProgressDTO::getLibraryName);
		final Ordering<WorkflowUserProgressDTO> orderUser = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowUserProgressDTO::getUserFullName);
