...
public class StatisticsProviderDeliveryDTO implements Comparable<StatisticsProviderDeliveryDTO> {
	...
	static {
		Ordering<StatisticsProviderDeliveryDTO> orderLib = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsProviderDeliveryDTO::getLibraryName);
		Ordering<StatisticsProviderDeliveryDTO> orderProvider = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsProviderDeliveryDTO::getProviderFullName);
