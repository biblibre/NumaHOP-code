...
public class LotWithConfigRulesDTO extends AbstractVersionedDTO {
	...
	public LotWithConfigRulesDTO(final String identifier, final String label, final String code, final String type,
			final String description, final Boolean active, final String status, final String condNotes,
			final String numNotes, final String requiredFormat, final Date deliveryDateForseen,
			final SimpleProjectDTO project, final SimpleFTPConfigurationDTO activeFTPConfiguration,
			final CheckConfigurationDTO activeCheckConfiguration,
			final SimpleViewsFormatConfigurationDTO activeFormatConfiguration,
			final InternetArchiveCollectionDTO collectionIA, final CinesPACDTO planClassementPAC,
			final SimpleUserDTO provider, final String requiredTypeCompression, final Integer requiredTauxCompression,
			final String requiredResolution, final String requiredColorspace, final String createdBy,
			final LocalDateTime createdDate, final String lastModifiedBy, final LocalDateTime lastModifiedDate,
			final OmekaConfigurationDTO omekaConfiguration, final OmekaListDTO omekaCollection,
			final OmekaListDTO omekaItem, final OcrLanguageDTO activeOcrLanguage) {
	...
	public static final class Builder {
		...
		public LotWithConfigRulesDTO build() {
			return new LotWithConfigRulesDTO(identifier, label, code, type, description, active, status, condNotes,
					numNotes, requiredFormat, deliveryDateForseen, project, activeFTPConfiguration,
					activeCheckConfiguration, activeFormatConfiguration, collectionIA, planClassementPAC, provider,
					requiredTypeCompression, requiredTauxCompression, requiredResolution, requiredColorspace, createdBy,
					createdDate, lastModifiedBy, lastModifiedDate, omekaConfiguration, omekaCollection, omekaItem,
					activeOcrLanguage);
		}
