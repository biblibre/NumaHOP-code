...
public class StatisticsProgressDTO implements Comparable<StatisticsProgressDTO> {
	...
	static {
		final Ordering<StatisticsProgressDTO> orderLib = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsProgressDTO::getLibraryName);
		final Ordering<StatisticsProgressDTO> orderPj = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsProgressDTO::getProjectName);
		final Ordering<StatisticsProgressDTO> orderLot = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsProgressDTO::getLotLabel);
