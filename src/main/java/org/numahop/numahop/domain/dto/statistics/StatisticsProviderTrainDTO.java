...
public class StatisticsProviderTrainDTO implements Comparable<StatisticsProviderTrainDTO> {
	...
	static {
		Ordering<StatisticsProviderTrainDTO> orderLib = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsProviderTrainDTO::getLibraryName);
		Ordering<StatisticsProviderTrainDTO> orderProject = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsProviderTrainDTO::getProjectName);
		Ordering<StatisticsProviderTrainDTO> orderTrain = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsProviderTrainDTO::getTrainLabel);
