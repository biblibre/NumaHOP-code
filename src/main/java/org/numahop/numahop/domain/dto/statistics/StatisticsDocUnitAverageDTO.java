...
public class StatisticsDocUnitAverageDTO implements Comparable<StatisticsDocUnitAverageDTO> {
	...
	static {
		final Ordering<StatisticsDocUnitAverageDTO> orderPj = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsDocUnitAverageDTO::getProjectName);
		final Ordering<StatisticsDocUnitAverageDTO> orderLot = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsDocUnitAverageDTO::getLotLabel);
		final Ordering<StatisticsDocUnitAverageDTO> orderDlv = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsDocUnitAverageDTO::getDeliveryLabel);
