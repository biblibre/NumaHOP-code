package org.numahop.numahop.domain.document.common;
 ...
 *
 * @author jbrunet Créé le 21 févr. 2017
 */
@Entity
...
public class LanguageCode extends AbstractDomainObject {
	...
	/**
	 * ISO 639-2 (Bibliographic) (équivalence anglaise sur certaines langues Ex: fre au
	 * lieu de fra pour le français)
	 */
