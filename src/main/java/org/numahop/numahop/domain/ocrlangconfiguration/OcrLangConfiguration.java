...
// @JsonSubTypes({@JsonSubTypes.Type(name = "ocrLangConfiguration", value =
// OcrLangConfiguration.class)})
public class OcrLangConfiguration extends AbstractDomainObject {
	 ...
	 */
	@OneToMany(mappedBy = "ocrLangConfiguration", orphanRemoval = true, fetch = FetchType.LAZY,
