...
@Entity
@DiscriminatorValue(value = WorkflowStateKey.Values.VALIDATION_CONSTAT_ETAT)
public class ValidationConstatEtatState extends DocUnitState {

	@Override
	public WorkflowStateKey getKey() {
		return WorkflowStateKey.VALIDATION_CONSTAT_ETAT;
	}
	...
	protected List<DocUnitState> getNextStates() {
		...
		states.add(getWorkflow().getFutureOrRunningByKey(WorkflowStateKey.VALIDATION_BORDEREAU_CONSTAT_ETAT));
