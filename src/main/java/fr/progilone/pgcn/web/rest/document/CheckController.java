...
public class CheckController extends AbstractRestController {
	...
	@Autowired
	public CheckController(final UICheckService uiCheckService, final CheckService checkService,
			final SlipService slipService, final AccessHelper accessHelper) {
		super();
	...
	public DocErrorReport setErrors(@RequestBody final DocPageErrorsDTO errors, @PathVariable final String id,
			@RequestParam final Integer pageNumber, @RequestParam final String deliveryId) {
	...
	public DocErrorReport setErrorsForSampling(@RequestBody final DocPageErrorsDTO errors,
			@PathVariable final String id, @RequestParam final Integer pageNumber,
	...
	@ResponseStatus(HttpStatus.ACCEPTED)
	@RolesAllowed(CHECK_HAB3)
	public Set<Check.ErrorLabel> getErrorsForSampling(@PathVariable final String id,
	...
	@Timed
	@RolesAllowed(CHECK_HAB3)
	public ResponseEntity<Map<String, Object>> getDocumentSummaryResults(@PathVariable final String id,
			@RequestParam final String deliveryId) {
	...
	public void generateCheckSlip(final HttpServletRequest request, final HttpServletResponse response,
			@PathVariable final String id,
			@RequestParam(value = "encoding", defaultValue = "utf-8") final String encoding,
			@RequestParam(value = "separator", defaultValue = ";") final char separator) throws PgcnTechnicalException {
	...
	@Timed
	@RolesAllowed({ CHECK_HAB4, LOT_HAB0 })
	public void generateCheckSlipPdf(final HttpServletRequest request, final HttpServletResponse response,
			@PathVariable final String id) throws PgcnTechnicalException {
