...
public class RoleController extends AbstractRestController {
	...
	public ResponseEntity<Role> create(final HttpServletRequest request, @RequestBody final Role role)
	...
	public ResponseEntity<Role> udpate(final HttpServletRequest request, @RequestBody final Role role)
			throws PgcnException {
