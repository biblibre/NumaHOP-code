...
public final class AuthorizationConstants {
	...
	/**
	 * Habilitation à la gestion des bibliothèques: Visualiser (hors données de
	 * production)
	 */
	...
	/**
	 * Habilitation à la gestion des bibliothèques: Visualiser les projets et les données
	 * de production
	 */
	public static final String LIB_HAB7 = "LIB-HAB7";

	/**
	 * Habilitation à la gestion des bibliothèques: Exporter la liste / une fiche au
	 * format CSV
	 */
	...
	// ne pas oublier de placer l'annotation @AuthorizationManager.Init sur la classe pour
	// initialiser les relations entre autorisations
	static {
		...
		AuthorizationManager.setRequirements(AuthorizationConstants.LIB_HAB7, AuthorizationConstants.LIB_HAB5,
				AuthorizationConstants.LIB_HAB6);
