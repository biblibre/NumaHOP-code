...
public class Z3950ServerController extends AbstractRestController {
	 ...
	 * @param z3950Server le serveur à créer (objet <code>Z3950Server</code>).
	 * @return l'objet <code>Z3950Server</code> créé.
	 * @throws PgcnValidationException si erreur lors du create
	 */
	@RequestMapping(method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	@RolesAllowed({ Z3950_HAB1 })
	public ResponseEntity<Z3950Server> create(@RequestBody final Z3950Server z3950Server)
	 ...
	 * @param id identifiant du serveur à récupérer.
	 ...
	 * @throws PgcnValidationException si erreur lors du save
	 */
	@RequestMapping(value = "/{id}", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	@RolesAllowed({ Z3950_HAB1 })
	public ResponseEntity<Z3950Server> udpate(@RequestBody final Z3950Server z3950Server)
			throws PgcnValidationException {
