...
public class WorkflowModelController extends AbstractRestController {
	...
	@Autowired
	public WorkflowModelController(final WorkflowModelService service, final UIWorkflowModelService uiService,
	...
	public ResponseEntity<Page<SimpleWorkflowModelDTO>> search(final HttpServletRequest request,
		...
		if (libraries != null && !libraries.isEmpty()) {
			filteredLibraries = libraries.stream()
				.filter(lib -> libraryAccesssHelper.checkLibrary(request, lib))
	...
	@RequestMapping(method = RequestMethod.GET, params = { "models", "library" },
