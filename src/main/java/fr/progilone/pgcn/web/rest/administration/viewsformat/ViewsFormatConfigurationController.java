...
public class ViewsFormatConfigurationController extends AbstractRestController {
	...
	public ResponseEntity<Page<SimpleViewsFormatConfigurationDTO>> search(final HttpServletRequest request,
		...
		return new ResponseEntity<>(uiViewsFormatConfigurationService.search(search, filteredLibraries, page, size),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<ViewsFormatConfigurationDTO> create(final HttpServletRequest request,
		...
		final ViewsFormatConfigurationDTO savedConfiguration = uiViewsFormatConfigurationService
			.create(formatConfiguration);
	...
	public ResponseEntity<List<SimpleViewsFormatConfigurationDTO>> getByProjectId(final HttpServletRequest request,
		...
		final List<SimpleViewsFormatConfigurationDTO> configurations = uiViewsFormatConfigurationService
	...
	@Timed
	@RolesAllowed({ IMG_FORMAT_HAB0 })
	public ResponseEntity<ViewsFormatConfigurationDTO> getById(final HttpServletRequest request,
			@PathVariable final String id) {
		// Chargement
