...
public final class AuthorizationConstants {
	...
	static {
		AuthorizationManager.setRequirements(AuthorizationConstants.WORKFLOW_HAB1,
				AuthorizationConstants.WORKFLOW_HAB4);
		AuthorizationManager.setRequirements(AuthorizationConstants.WORKFLOW_HAB2,
				AuthorizationConstants.WORKFLOW_HAB4);
		AuthorizationManager.setRequirements(AuthorizationConstants.WORKFLOW_HAB3,
				AuthorizationConstants.WORKFLOW_HAB4);
	}
