...
public class UIOcrLangConfigurationService {
	...
	public UIOcrLangConfigurationService(final OcrLangConfigurationService ocrLangConfigurationService,
			final UIOcrLangConfigMapper ocrConfigMapper) {
	 ...
	 */
	@Transactional(readOnly = true)
	public Page<SimpleOcrLangConfigDTO> search(final String search, final List<String> libraries, final Integer page,
			final Integer size) {
		final Pageable pageRequest = PageRequest.of(page, size);
		final Page<OcrLangConfiguration> ocrLangConfigs = ocrLangConfigurationService.search(search, libraries,
				pageRequest);
