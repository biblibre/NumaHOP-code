...
/**
 * Classe pour convertir des dates java.util.date en date java.time (java 8) et
 * inversement
 */
public final class DateUtils {
	...
	private static final Separator[] dateSeparators = { new Separator("/"), new Separator("-"),
	...
	/**
	 * @param date une date de type java.time.LocalDate
	...
	/**
	 * @param datetime une date de type java.time.LocalDate
	 * @return Retourne une date de type java.util.Date
	 */
	 ...
	 * @param start
	 * @param end
	 * @param unit (valeur par défaut ChronoUnit.DAYS)
	 * @return long
	 */
	 ...
	 * @param date la date
	 * @param start borne inférieure, incluse
	 * @param end borne supérieure, exclue
	 * @return boolean
	 */
	public static boolean isBetween(final Date date, final Date start, final Date end, final boolean includeStart,
	 ...
	 * @param date date, null retourne false
	 * @param start borne inférieure, peut être null, considéré comme -infini
	 * @param end borne supérieure, peut être null, considéré comme +infini
	 * @param inclusive si les bornes sont considérés comme valables, ie l'intervalle est
	 * [start, end] et non plus ]start, end[
	 * @return
	 */
	 ...
	 * @param datetime date, null retourne false
	 * @param start borne inférieure, peut être null, considéré comme -infini
	 * @param end borne supérieure, peut être null, considéré comme +infini
	 * @param inclusive si les bornes sont considérés comme valables, ie l'intervalle est
	 * [start, end] et non plus ]start, end[
	 * @return
	 */
	public static boolean isBetween(final LocalDateTime datetime, LocalDateTime start, LocalDateTime end,
	...
	/**
	 * Différents formats de dates à reconnaitre. Attention l'ordre est important car on
	 * les identifie dans cet ordre, si une date peut matcher 2 pattern (ex 20121606 qui
	 * peut être 20/12/1606 ou 16/06/2012), l'ordre permet de savoir quel pattern sera
	 * choisi en premier (en l'occurence ça sera 16/06/2012)
	 */
