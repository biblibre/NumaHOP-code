...
public class DocUnitToJenaService {
	...
	/**
	 * Convertit l'unité documentaire en RDFXML, et écrit le résultat dans l'OutputStream
	 * passé en paramètre
	 * @param out
	 * @param docUnit
	 * @param rdfProperties
	...
	/**
	 * Convertit l'unité documentaire en RDFXML, et retourne le résultat sous la forme
	 ...
	 * @throws IOException
	 */
	public void convert(final OutputStream out, final DocUnit docUnit,
			final DocPropertyType.DocPropertySuperType superType) throws IOException {
	 ...
	 * @throws IOException
	 */
	public String convert(final DocUnit docUnit, final DocPropertyType.DocPropertySuperType superType)
			throws IOException {
		...
		try (final OutputStream out = new ByteArrayOutputStream();
			...
			return out.toString(); // retourne le contenu du ByteArrayOutputStream sous
									// forme de String
		}
	}
	...
	/**
	 * Création d'une Map nom ppté => ppté à partir des vocabulaires passés en paramètres
