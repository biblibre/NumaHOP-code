...
public abstract class CustomScript {
	...
	private static final Map<String, Class<? extends CustomScript>> scripts = Collections
	...
	/**
	 * Script servant à configurer ce {@link CustomScript} Il est exécuté à la création de
	 * cet objet
	 * @return
	 */
	...
	/**
	 * Définition d'une closure Groovy permettant d'appeler ce script simplement à partir
	 * des règles de mapping
	 * <p>
	 * Les script sont bindés dans une Map<String, CustomScript>, dont la clé est
	 * l'identifiant du formatter.
	 * @return
	 */
