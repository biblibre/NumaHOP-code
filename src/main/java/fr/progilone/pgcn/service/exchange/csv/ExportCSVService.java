...
public class ExportCSVService {
	 ...
	 */
	public <T extends Comparable<T>> void exportOrderedBeans(final List<T> beans, final OutputStream out,
			final String encoding, final char separator) throws IOException, PgcnTechnicalException {
	...
	public String getFormatedValues(final List<String> values, final String emptyFieldValue,
			final String csvRepeatedFieldSep) throws IOException {
