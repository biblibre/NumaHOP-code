...
/**
 * Ce formatter extrait les données textuelles d'un objet, en supprimant les données de
 * mise en forme
 * <p>
...
public class TextFormatter extends CustomScript {
	...
	/**
	 * Formattage d'un objet Parcourt la hiérarchie d'objets à la recherche de valeurs
	 * textuelles
	 * @param o
	 * @return
	 */
	public String format(final Object o) {
		try {
			final List<Object> nextValues = EadCParser.getNextValues(o)
				.stream()
			...
			for (final Object val : nextValues) {
				...
				if (val instanceof String) {
					...
					// Si l'attribut "normal" n'existe pas ou qu'il n'est pas renseigné,
					// on poursuit le formattage avec val
