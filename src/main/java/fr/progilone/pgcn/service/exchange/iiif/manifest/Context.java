...
@JsonPropertyOrder({ "sc", "iiif", "exif", "oa", "cnt", "dc", "dcterms", "dctypes", "doap", "foaf", "rdf", "rdfs",
		"xsd", "svcs", "as", "license", "service", "seeAlso", "within", "profile", "related", "logo", "thumbnail",
		"startCanvas", "contentLayer", "members", "collections", "manifests", "sequences", "canvases", "resources",
		"images", "otherContent", "structures", "ranges", "metadata", "description", "navDate", "rendering", "height",
		"width", "attribution", "viewingDirection", "viewingHint", "left-to-right", "right-to-left", "top-to-bottom",
		"bottom-to-top", "paged", "non-paged", "continuous", "individuals", "top", "multi-part", "facing-pages",
		"motivation", "resource", "on", "full", "selector", "stylesheet", "style", "default", "item", "chars",
		"encoding", "bytes", "format", "language", "value", "label", "prefix", "suffix", "exact", "first", "last",
		"next", "prev", "total", "startIndex" })
public class Context {
	 ...
	 * @param first
	 */
	public Context(String sc, String iiif, String exif, String oa, String cnt, String dc, String dcterms,
			String dctypes, String doap, String foaf, String rdf, String rdfs, String xsd, String svcs, String as,
			License license, Service service, SeeAlso seeAlso, Within within, Profile profile, Related related,
			Logo logo, Thumbnail thumbnail, StartCanvas startCanvas, ContentLayer contentLayer, Members members,
			Collections collections, Manifests manifests, Sequences sequences, Canvases canvases, Resources resources,
			Images images, OtherContent otherContent, Structures structures, Ranges ranges, Metadata metadata,
			Description description, NavDate navDate, Rendering rendering, Height height, Width width,
			Attribution attribution, ViewingDirection viewingDirection, ViewingHint viewingHint, String leftToRight,
			String rightToLeft, String topToBottom, String bottomToTop, String paged, String nonPaged,
			String continuous, String individuals, String top, String multiPart, String facingPages,
			Motivation motivation, Resource resource, On on, Full full, Selector selector, Stylesheet stylesheet,
			Style style, Default _default, Item item, Chars chars, Encoding encoding, Bytes bytes, Format format,
			Language language, Value value, Label label, String prefix, String suffix, String exact, First first,
			Last last, Next next, Prev prev, Total total, StartIndex startIndex) {
		super();
		this.sc = sc;
		this.iiif = iiif;
		this.exif = exif;
