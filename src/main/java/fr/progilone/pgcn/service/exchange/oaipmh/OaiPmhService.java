 ...
 * Client OAI-PMH
 *
 * @see <a href="http://www.openarchives.org/OAI/openarchivesprotocol.html">The Open
 * Archives Initiative Protocol for Metadata Harvesting</a>
 */
@Service
public class OaiPmhService {
	 ...
	 * @return
	 * @see <a href=
	 * "http://www.openarchives.org/OAI/openarchivesprotocol.html#GetRecord">GetRecord</a>
	 */
	 ...
	 * @return
	 * @see <a href=
	 * "http://www.openarchives.org/OAI/openarchivesprotocol.html#Identify">Identify</a>
	 */
	 ...
	 * @param until yyyy-MM-dd
	 * @param set
	 * @param token
	 * @return
	 * @see <a href=
	 * "http://www.openarchives.org/OAI/openarchivesprotocol.html#ListIdentifiers">ListIdentifiers</a>
	 */
	public Optional<OAIPMHtype> listIdentifiers(final String baseUrl, final String prefix, final String from,
			final String until, final String set, final String token) {
		try {
	 ...
	 * @return
	 * @see <a href=
	 * "http://www.openarchives.org/OAI/openarchivesprotocol.html#ListMetadataFormats">ListMetadataFormats</a>
	 */
	 ...
	 * @return
	 * @see <a href=
	 * "http://www.openarchives.org/OAI/openarchivesprotocol.html#ListRecords">ListRecords</a>
	 */
	public Optional<OAIPMHtype> listRecords(final String baseUrl, final String prefix, final String from,
			final String until, final String set, final String token) {
		try {
	 ...
	 * @return
	 * @see <a href=
	 * "http://www.openarchives.org/OAI/openarchivesprotocol.html#ListSets">ListSets</a>
	 */
	...
	private Optional<OAIPMHtype> get(final String url) throws IOException, JAXBException {
		...
		if (statusCode >= 200 && statusCode < 300) {
			...
			LOG.error("La requête {} a échoué avec l'erreur {}: {}", url, statusCode,
