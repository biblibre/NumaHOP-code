...
public class Z3950Service {
	...
	// code=\"c\">[Archipoche]</marcxml:subfield>\r\n <marcxml:subfield code=\"d\">cop.
	// 2013</marcxml:subfield>\r\n <marcxml:subfield
	...
	// code=\"b\">759999999</marcxml:subfield>\r\n <marcxml:subfield
	...
	private Connection createConnection(final Z3950Server z3950Server) throws ZoomException {
		 ...
		 * (application-xxx.yml)
		 *
		 * => Install sous debian: apt-get install libyaz4 => Install sous windows:
		 * http://www.indexdata.com/yaz + La librairie yaz4j.dll et ses dépendances sont
		 * accessibles via la variable d'environnement PATH
		 */
