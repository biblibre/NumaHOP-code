...
public class RuleKey {
	...
	/**
	 * Expression régulière permettant de rechercher la variable représentée par cette
	 * RuleKey dans un script
	 * @return
	 */
	public String getRegex() {
		String regex = field.replaceAll("\\.", "\\\\.");
		// le nom du champ est précédé d'un \, est eventuellement entre accolades {...},
		// et la fin de mot n'est pas suivie d'un point
		regex = "\\\\\\{?" + regex + "\\b(?!\\.)\\}?";
		return regex;
	}
