...
public class MailboxService {
	 ...
	 */
	public void readMailbox(MailboxConfiguration conf, Consumer<Message[]> messageConsumer)
			throws PgcnTechnicalException {
		...
		try {
			...
			store.connect(conf.getHost(), conf.getPort(), conf.getUsername(),
					cryptoService.decrypt(conf.getPassword()));
