...
public abstract class BibliographicRecordMapperDecorator implements BibliographicRecordMapper {
	...
	@Override
	public DocUnitBibliographicRecordDTO bibliographicRecordToDocUnitBibliographicRecordDTO(
			final BibliographicRecord record) {
	...
	@Override
	public SimpleBibliographicRecordDTO bibliographicRecordToSimpleBibliographicRecordDTO(
			final BibliographicRecord record) {
