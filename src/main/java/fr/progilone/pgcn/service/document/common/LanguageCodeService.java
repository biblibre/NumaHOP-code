 ...
 *
 * @author jbrunet Créé le 22 févr. 2017
 */
@Service
public class LanguageCodeService {
	...
	/**
	 * Récupération d'un {@link LanguageCode} en fonction d'un code qui peut correspondre
	 * à Valeur ISO 639 1 Valeur ISO 639 2(T) Valeur ISO 639 2(B)
	 * @param code
	 * @return
	 */
	...
	public LanguageCode searchOneByCode(final String code) {
		...
		return languageCodeRepository.getAllByNameOrIso6392tOrIso6392bOrIso6391(code, code, code, code)
			.stream()
			.findFirst()
			.orElse(null);
	}
	...
	/**
	 * Retourne le code ISO6393 2 B (Marc21) pour le langage si présent, sinon le ISO6393
	 * 2
	 * @param language
	 * @return
	 */
