	...
	public void validate(final DocUnit doc) throws PgcnValidationException {
		...
		// statut + pgcn_id unique
			...
			final Long countDuplicates = doc.getIdentifier() == null
					? docUnitRepository.countByPgcnIdAndState(doc.getPgcnId(), doc.getState()) : docUnitRepository
						.countByPgcnIdAndStateAndIdentifierNot(doc.getPgcnId(), doc.getState(), doc.getIdentifier());
