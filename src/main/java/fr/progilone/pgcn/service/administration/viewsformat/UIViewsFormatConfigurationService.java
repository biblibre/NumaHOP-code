...
public class UIViewsFormatConfigurationService {
	...
	public UIViewsFormatConfigurationService(final ViewsFormatConfigurationService viewsFormatConfigurationService,
			final ProjectService projectService, final DefaultFileFormats defaultFormats) {
	...
	public ViewsFormatConfigurationDTO create(final ViewsFormatConfigurationDTO confDTO) {
		...
		final ViewsFormatConfiguration formatConfiguration = ViewsFormatConfigurationMapper.INSTANCE
			.dtoToFormatConfig(confDTO);
	 ...
	 */
	@Transactional(readOnly = true)
	public Page<SimpleViewsFormatConfigurationDTO> search(final String search, final List<String> libraries,
