...
public class Z3950Server extends AbstractDomainObject {
	...
	public String toString() {
		return "Z3950Server{" + "name='" + name + '\'' + ", host='" + host + '\'' + ", port=" + port + ", database='"
				+ database + '\'' + ", userId='" + userId + '\'' + ", active=" + active + ", dataFormat=" + dataFormat
				+ ", dataEncoding=" + dataEncoding + ", recordType=" + recordType + '}';
	}
