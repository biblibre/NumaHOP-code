...
public class Dsc {
	 ...
	 * @param value allowed object is {@link Thead }
	 */
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the cAndThead
	 * property.
	 * <p>
	 * <p>
	 * For example, to add a new item, do as follows:
	 ...
	 * <p>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link C } {@link Thead }
	 */
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the c01AndThead
	 * property.
	 * <p>
	 * <p>
	 * For example, to add a new item, do as follows:
	 ...
	 * <p>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link C01 } {@link Thead
	 * }
	 */
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the dsc
	 * property.
	 * <p>
	 * <p>
	 * For example, to add a new item, do as follows:
	 ...
	 * <p>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Dsc }
	 */
