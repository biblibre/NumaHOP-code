...
@XmlType(name = "validatorType", propOrder = { "fileName", "fileSize", "version", "wellformed", "valid", "message",
		"md5Sum", "sha256Sum", "note", "archivable", "format", "encoding" })
public class ValidatorType {
	 ...
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the note
	 * property.
	 *
	 * <p>
