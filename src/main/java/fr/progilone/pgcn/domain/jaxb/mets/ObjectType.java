...
/**
 * objectType: complexType for interfaceDef and mechanism elements The mechanism and
 * behavior elements point to external objects--an interface definition object or an
 * executable code object respectively--which together constitute a behavior that can be
 * applied to one or more <div> elements in a <structMap>.
 *
 *
 * <p>
