...
/**
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;description xmlns="http://www.cines.fr/pac/ppdi"
 ...
 * xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;Présentation du producteur du fonds&lt;/description&gt;
 * </pre>
 *
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;commentaires xmlns="http://www.cines.fr/pac/ppdi"
 * xmlns:ISO-639-3="urn:un:unece:uncefact:codelist:draft:DAF:languageCode:2011-10-07"
 * xmlns:RA="urn:un:unece:uncefact:codelist:draft:DAF:accessRestrictionCode:2009-08-18"
 * xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;
 * Le producteur est l'entité (organisme(s), personne ou groupe de personnes) responsable de la création du fonds. Dans
 * le cas de documents numérisés, il faut comprendre par
 * producteur, le producteur du fonds original et non le responsable de la numérisation. Dans tous les cas, si le
 * producteur est le service versant, ne pas remplir cette partie.
 * S'il existe une multitude de producteurs qui ne sont pas clairement identifiables, ne pas remplir cette partie et
 * renseigner dans le détail, le circuit de production et de
 * collecte.
 * &lt;/commentaires&gt;
 * </pre>
 * <p>
