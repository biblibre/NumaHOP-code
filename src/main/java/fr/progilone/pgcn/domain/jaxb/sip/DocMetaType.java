...
@XmlType(name = "DocMetaType", propOrder = { "identifiantDocProducteur", "docRelation", "evaluation", "communicabilite",
		"noteDocument", "serviceVersant", "planClassement", "structureDocument", "version", "versionPrecedente" })
