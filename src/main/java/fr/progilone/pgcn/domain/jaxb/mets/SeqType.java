...
/**
 * seqType: Complex Type for Sequences of Files The seq element should be used to link a
 * div to a set of content files when those files should be played/displayed sequentially
 * to deliver content to a user. Individual <area> subelements within the seq element
 * provide the links to the files or portions thereof.
 *
 *
 * <p>
...
@XmlType(name = "seqType", propOrder = { "areaOrPar" })
public class SeqType {

	@XmlElements({ @XmlElement(name = "area", type = AreaType.class), @XmlElement(name = "par", type = ParType.class) })
	 ...
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the areaOrPar
	 * property.
	 *
	 * <p>
