...
/**
 * <p>
 * Classe Java pour c07 complex type.
 *
 * <p>
...
@XmlType(name = "c07", propOrder = { "head", "did", "mDescFull", "theadAndC08" })
public class C07 {
	...
	@XmlElements({ @XmlElement(name = "accessrestrict", type = Accessrestrict.class),
			@XmlElement(name = "accruals", type = Accruals.class), @XmlElement(name = "acqinfo", type = Acqinfo.class),
			...
			@XmlElement(name = "descgrp", type = Descgrp.class), @XmlElement(name = "fileplan", type = Fileplan.class),
			@XmlElement(name = "index", type = Index.class), @XmlElement(name = "odd", type = Odd.class),
			...
			@XmlElement(name = "userestrict", type = Userestrict.class), @XmlElement(name = "dsc", type = Dsc.class),
			@XmlElement(name = "dao", type = Dao.class), @XmlElement(name = "daogrp", type = Daogrp.class),
			@XmlElement(name = "note", type = Note.class) })
	protected List<Object> mDescFull;

	@XmlElements({ @XmlElement(name = "thead", type = Thead.class), @XmlElement(name = "c08", type = C08.class) })
	 ...
	 * @return possible object is {@link Did }
	 *
	 */
	public Did getDid() {
		return did;
	 ...
	 * @param value allowed object is {@link Did }
	 *
	 */
	 ...
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the mDescFull
	 * property.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Accessrestrict }
	 * {@link Accruals } {@link Acqinfo } {@link Altformavail } {@link Appraisal }
	 * {@link Arrangement } {@link Bibliography } {@link Bioghist } {@link Controlaccess }
	 * {@link Custodhist } {@link Descgrp } {@link Fileplan } {@link Index } {@link Odd }
	 * {@link Originalsloc } {@link Otherfindaid } {@link Phystech } {@link Prefercite }
	 * {@link Processinfo } {@link Relatedmaterial } {@link Scopecontent }
	 * {@link Separatedmaterial } {@link Userestrict } {@link Dsc } {@link Dao }
	 * {@link Daogrp } {@link Note }
	 *
	 *
	 */
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the theadAndC08
	 * property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 ...
	 *
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Thead } {@link C08
	 * }
	 *
	 *
	 */
	 ...
	 * @return possible object is {@link AvLevel }
	 *
	 */
	 ...
	 * @param value allowed object is {@link AvLevel }
	 *
	 */
