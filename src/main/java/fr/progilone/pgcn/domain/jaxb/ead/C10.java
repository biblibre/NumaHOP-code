...
/**
 * <p>
 * Classe Java pour c10 complex type.
 *
 * <p>
...
@XmlType(name = "c10", propOrder = { "head", "did", "mDescFull", "theadAndC11" })
public class C10 {
	...
	@XmlElements({ @XmlElement(name = "thead", type = Thead.class), @XmlElement(name = "c11", type = C11.class) })
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the theadAndC11
	 * property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 ...
	 *
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Thead } {@link C11
	 * }
	 *
	 *
	 */
