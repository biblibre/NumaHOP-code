...
/**
 * <p>
 * Classe Java pour c04 complex type.
 *
 * <p>
...
@XmlType(name = "c04", propOrder = { "head", "did", "mDescFull", "theadAndC05" })
public class C04 {
	...
	@XmlElements({ @XmlElement(name = "thead", type = Thead.class), @XmlElement(name = "c05", type = C05.class) })
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the theadAndC05
	 * property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 ...
	 *
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Thead } {@link C05
	 * }
	 *
	 *
	 */
