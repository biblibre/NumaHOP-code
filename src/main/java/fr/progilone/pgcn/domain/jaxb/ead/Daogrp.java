...
@XmlType(name = "daogrp", propOrder = { "daodesc", "daolocOrResourceOrArc" })
public class Daogrp {

	protected Daodesc daodesc;

	@XmlElements({ @XmlElement(name = "daoloc", type = Daoloc.class),
			@XmlElement(name = "resource", type = Resource.class), @XmlElement(name = "arc", type = Arc.class),
			@XmlElement(name = "ptrloc", type = Ptrloc.class), @XmlElement(name = "extptrloc", type = Extptrloc.class),
	 ...
	 * daolocOrResourceOrArc property.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Daoloc }
	 * {@link Resource } {@link Arc } {@link Ptrloc } {@link Extptrloc } {@link Refloc }
	 * {@link Extrefloc }
	 *
	 *
	 */
