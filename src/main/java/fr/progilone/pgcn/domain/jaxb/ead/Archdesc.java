...
/**
 * <p>
 * Classe Java pour archdesc complex type.
 * <p>
...
@XmlType(name = "archdesc", propOrder = { "runner", "did", "mDescFull" })
public class Archdesc {
	 ...
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the runner
	 * property.
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Runner }
	 */
