...
public class Linkgrp {
	...
	@XmlElements({ @XmlElement(name = "resource", type = Resource.class), @XmlElement(name = "arc", type = Arc.class),
	 ...
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the extendedEls
	 * property.
	 * <p>
	 ...
	 * {@link Arc } {@link Ptrloc } {@link Extptrloc } {@link Refloc } {@link Extrefloc }
	 */
