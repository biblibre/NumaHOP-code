...
@XmlType(name = "controlaccess", propOrder = { "head", "addressOrChronlistOrList" })
public class Controlaccess {
	...
	@XmlElements({ @XmlElement(name = "address", type = Address.class),
			...
			@XmlElement(name = "corpname", type = Corpname.class), @XmlElement(name = "famname", type = Famname.class),
			@XmlElement(name = "geogname", type = Geogname.class), @XmlElement(name = "name", type = Name.class),
	 ...
	 * {@link P } {@link Corpname } {@link Famname } {@link Geogname } {@link Name }
	 * {@link Occupation } {@link Persname } {@link Subject } {@link Genreform }
	 * {@link Function } {@link Title } {@link Controlaccess }
	 *
	 *
	 */
