...
/**
 * <p>
 * Classe Java pour langmaterial complex type.
 * <p>
...
@XmlType(name = "langmaterial", propOrder = { "content" })
public class Langmaterial {
	...
	@XmlElementRefs({
			...
			@XmlElementRef(name = "expan", namespace = "urn:isbn:1-931666-22-9", type = JAXBElement.class,
					required = false),
			@XmlElementRef(name = "language", namespace = "urn:isbn:1-931666-22-9", type = JAXBElement.class,
					required = false),
	 ...
	 * }{@code <}{@link Abbr }{@code >} {@link JAXBElement }{@code <}{@link Expan
	 * }{@code >} {@link JAXBElement }{@code <}{@link Language }{@code >}
	 ...
	 * }{@code <}{@link Title }{@code >} {@link JAXBElement }{@code <}{@link Archref
	 * }{@code >}
	 */
