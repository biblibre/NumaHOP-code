 ...
 * &lt;simpleContent&gt;
 * &lt;extension
 * base="&lt;urn:un:unece:uncefact:codelist:draft:DAF:accessRestrictionCode:2009-08-18&gt;AccessRestrictionCodeType"&gt;
...
public class CodeType {
	 ...
	 * xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;Table des codes
	 * pour la restriction d'accès&lt;/ccts:Name&gt;
	 * </pre>
	 *
	 * <pre>
	 ...
	 * xmlns="urn:un:unece:uncefact:codelist:draft:DAF:accessRestrictionCode:2009-08-18"
	 * xmlns:clmDAFAccessRestrictionCode="urn:un:unece:uncefact:codelist:draft:DAF:accessRestrictionCode:2009-08-18"
	 * xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;Les différentes
	 * valeurs de cette table sont tirées de la loi archive.&lt;/ccts:Description&gt;
	 * </pre>
