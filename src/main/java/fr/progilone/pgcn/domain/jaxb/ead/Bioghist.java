...
/**
 * <p>
 * Classe Java pour bioghist complex type.
 *
 * <p>
...
@XmlType(name = "bioghist", propOrder = { "head", "addressOrChronlistOrList" })
public class Bioghist {
	...
	@XmlElements({ @XmlElement(name = "address", type = Address.class),
			...
			@XmlElement(name = "bioghist", type = Bioghist.class), @XmlElement(name = "dao", type = Dao.class),
	 ...
	 * {@link P } {@link Bioghist } {@link Dao } {@link Daogrp }
	 *
	 *
	 */
