...
@XmlType(name = "revisiondesc", propOrder = { "list", "change" })
public class Revisiondesc {
	 ...
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the change
	 * property.
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Change }
	 */
