...
/**
 * fileType: Complex Type for Files The file element provides access to content files for
 * a METS object. A file element may contain one or more FLocat elements, which provide
 * pointers to a content file, and/or an FContent element, which wraps an encoded version
 * of the file. Note that ALL FLocat and FContent elements underneath a single file
...
@XmlType(name = "fileType", propOrder = { "fLocat", "fContent", "stream", "transformFile", "file" })
public class FileType {
	 ...
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the fLocat
	 * property.
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link FLocat }
	 */
	 ...
	 * @return possible object is {@link FContent }
	 */
	 ...
	 * @param value allowed object is {@link FContent }
	 */
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the stream
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link TransformFile }
	 */
	...
	public static class FContent {
		 ...
		 * @return possible object is {@link XmlData }
		 */
		 ...
		 * @param value allowed object is {@link XmlData }
		 */
