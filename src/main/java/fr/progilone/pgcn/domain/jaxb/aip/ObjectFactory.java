...
public class ObjectFactory {
	...
	// */
	// @XmlElementDecl(namespace =
	// "urn:un:unece:uncefact:codelist:draft:DAF:accessRestrictionCode:2009-08-18", name =
	// "AccessRestrictionCode")
	// public JAXBElement<AccessRestrictionCodeType>
	// createAccessRestrictionCode(AccessRestrictionCodeType value) {
	// return new JAXBElement<AccessRestrictionCodeType>(_AccessRestrictionCode_QNAME,
