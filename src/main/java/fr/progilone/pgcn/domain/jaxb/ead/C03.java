...
/**
 * <p>
 * Classe Java pour c03 complex type.
 * <p>
...
@XmlType(name = "c03", propOrder = { "head", "did", "mDescFull", "theadAndC04" })
public class C03 {
	...
	@XmlElements({ @XmlElement(name = "thead", type = Thead.class), @XmlElement(name = "c04", type = C04.class) })
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the theadAndC04
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Thead } {@link C04
	 * }
	 */
	public List<Object> getTheadAndC04() {
		if (theadAndC04 == null) {
			theadAndC04 = new ArrayList<>();
		}
