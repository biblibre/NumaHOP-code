 ...
 * aggregates pointers to files, parts of files, and/or sequences of files or parts of
 * files that must be played or displayed simultaneously to manifest a block of digital
