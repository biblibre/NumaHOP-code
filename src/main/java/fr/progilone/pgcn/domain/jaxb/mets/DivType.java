 ...
 * document.
 *
 * SPECIAL NOTE REGARDING DIV ATTRIBUTE VALUES: to clarify the differences between the
 * ORDER, ORDERLABEL, and LABEL attributes for the <div> element, imagine a text with 10
 * roman numbered pages followed by 10 arabic numbered pages. Page iii would have an ORDER
 * of "3", an ORDERLABEL of "iii" and a LABEL of "Page iii", while page 3 would have an
 * ORDER of "13", an ORDERLABEL of "3" and a LABEL of "Page 3".
 *
 *
 * <p>
