 ...
 * structurally as a series of nested div elements, that is, as a hierarchy (e.g., a book,
 * which is composed of chapters, which are composed of subchapters, which are composed of
 * text). Every div node in the structural map hierarchy may be connected (via subsidiary
 * mptr or fptr elements) to content files which represent that div's portion of the whole
 * document. SPECIAL NOTE REGARDING DIV ATTRIBUTE VALUES: to clarify the differences
 * between the ORDER, ORDERLABEL, and LABEL attributes for the &lt;div&gt; element,
 * imagine a text with 10 roman numbered pages followed by 10 arabic numbered pages. Page
 * iii would have an ORDER of "3", an ORDERLABEL of "iii" and a LABEL of "Page iii", while
 * page 3 would have an ORDER of "13", an ORDERLABEL of "3" and a LABEL of "Page 3".
 * <p>
...
public class DivType {
	 ...
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the mptr
	 * property.
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link DivType.Mptr }
	 */
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the fptr
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link DivType.Fptr }
	 */
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the dmdid
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the admid
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the contentids
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	...
	public static class Fptr {
		 ...
		 * the JAXB object. This is why there is not a &lt;CODE&gt;set&lt;/CODE&gt; method
		 * for the contentids property.
		 * </p>
		 * <p>
		 * For example, to add a new item, do as follows:
		 * </p>
