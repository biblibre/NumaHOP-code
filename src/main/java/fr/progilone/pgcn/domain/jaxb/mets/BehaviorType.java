...
/**
 * behaviorType: Complex Type for Behaviors A behavior can be used to associate executable
 * behaviors with content in the METS object. A behavior element has an interface
 * definition element that represents an abstract definition of the set of behaviors
 * represented by a particular behavior. A behavior element also has an behavior mechanism
 * which is a module of executable code that implements and runs the behavior defined
...
public class BehaviorType {
	 ...
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the structid
	 * property.
	 * <p>
