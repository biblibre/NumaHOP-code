...
/**
 * structLinkType: Complex Type for Structural Map Linking The Structural Map Linking
 * section allows for the specification of hyperlinks between different components of a
 * METS structure delineated in a structural map. structLink contains a single, repeatable
 * element, smLink. Each smLink element indicates a hyperlink between two nodes in the
 * structMap. The structMap nodes recorded in smLink are identified using their XML ID
 * attribute values.
 * <p>
...
public class StructLinkType {
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link SmLink }
	 * {@link SmLinkGrp }
	 */
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "smLocatorLink", "smArcLink" })
	public static class SmLinkGrp {
		 ...
		 * for the smLocatorLink property.
		 * </p>
		 * <p>
		 * For example, to add a new item, do as follows:
		 * </p>
		 ...
		 * </pre>
		 * <p>
		 * Objects of the following type(s) are allowed in the list {@link SmLocatorLink }
		 * </p>
		 */
		 ...
		 * </pre>
		 * <p>
		 * Objects of the following type(s) are allowed in the list {@link SmArcLink }
		 * </p>
		 */
		 ...
		 * The associated xlink:from and xlink:to attributes identify the from and to
		 * sides of the arc link by referencing the xlink:label attribute values on the
