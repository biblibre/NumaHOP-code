...
public class StructLinkType {
	...
	public static class SmLinkGrp {
		...
		/**
		 *
		 * The structMap arc link element <smArcLink> is of xlink:type "arc" It can be
		 * used to establish a traversal link between two <div> elements as identified by
