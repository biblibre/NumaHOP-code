...
/**
 * <p>
 * Classe Java pour scopecontent complex type.
 * <p>
...
@XmlType(name = "scopecontent", propOrder = { "head", "addressOrChronlistOrList" })
public class Scopecontent {
	...
	@XmlElements({ @XmlElement(name = "address", type = Address.class),
			...
			@XmlElement(name = "scopecontent", type = Scopecontent.class), @XmlElement(name = "dao", type = Dao.class),
	 ...
	 * {@link P } {@link Arrangement } {@link Scopecontent } {@link Dao } {@link Daogrp }
	 */
