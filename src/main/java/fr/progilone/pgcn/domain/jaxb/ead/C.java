...
@XmlType(name = "c", propOrder = { "head", "did", "mDescFull", "theadAndC" })
...
public class C {
	...
	@XmlElements({ @XmlElement(name = "thead", type = Thead.class), @XmlElement(name = "c", type = C.class) })
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present inside the
	 * JAXB object. This is why there is not a <CODE>set</CODE> method for the theadAndC
	 * property.
	 * </p>
	 * <p>
	 * For example, to add a new item, do as follows:
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Thead } {@link C }
	 */
	public List<Object> getTheadAndC() {
		if (theadAndC == null) {
			theadAndC = new ArrayList<>();
		}
