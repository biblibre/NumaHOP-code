...
/**
 * Présentation du circuit de production et de collecte des documents avant leur archivage
 * au CINES.
 * <p>
...
@XmlType(name = "CircuitProductionType", propOrder = { "productionCollecte", "numerisation" })
