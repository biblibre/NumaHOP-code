...
public class Delivery extends AbstractDomainObject {
	...
	public enum DeliveryStatus {
		...
		SAVED, DELIVERING, DELIVERED, TO_BE_CONTROLLED, VALIDATED, REJECTED, BACK_TO_PROVIDER, AUTOMATICALLY_REJECTED,
		DELIVERED_AGAIN, DELIVERING_ERROR, TREATED, CLOSED, CANCELED
