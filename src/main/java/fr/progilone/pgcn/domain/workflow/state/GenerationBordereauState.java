...
@Entity
@DiscriminatorValue(value = WorkflowStateKey.Values.GENERATION_BORDEREAU)
public class GenerationBordereauState extends DocUnitState {

	@Override
	public WorkflowStateKey getKey() {
		return WorkflowStateKey.GENERATION_BORDEREAU;
	}
