...
@Entity
@DiscriminatorValue(value = WorkflowStateKey.Values.DIFFUSION_DOCUMENT_LOCALE)
public class DiffusionDocumentLocaleState extends DocUnitState {

	@Override
	public WorkflowStateKey getKey() {
		return WorkflowStateKey.DIFFUSION_DOCUMENT_LOCALE;
	}
