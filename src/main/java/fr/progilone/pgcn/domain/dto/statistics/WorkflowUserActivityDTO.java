...
public class WorkflowUserActivityDTO implements Comparable<WorkflowUserActivityDTO> {
	...
	static {
		Ordering<WorkflowUserActivityDTO> orderLib = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowUserActivityDTO::getLibraryName);
		Ordering<WorkflowUserActivityDTO> orderUser = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowUserActivityDTO::getUserFullName);
		Ordering<WorkflowUserActivityDTO> orderPj = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowUserActivityDTO::getProjectName);
		Ordering<WorkflowUserActivityDTO> orderLot = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowUserActivityDTO::getLotLabel);
		Ordering<WorkflowUserActivityDTO> orderDoc = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowUserActivityDTO::getDocPgcnId);
