...
public class AddressDTO {
	...
	public AddressDTO(final String identifier, final String label, final String address1, final String address2,
			final String address3, final String complement, final String postcode, final String city,
			final String country, final Long version) {
		super();
	...
	public static final class Builder {
		...
		public AddressDTO build() {
			return new AddressDTO(identifier, label, address1, address2, address3, complement, postcode, city, country,
					version);
		}
