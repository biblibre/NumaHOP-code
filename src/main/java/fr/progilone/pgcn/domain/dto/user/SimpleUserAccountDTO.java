...
public class SimpleUserAccountDTO {
	...
	public SimpleUserAccountDTO(final String identifier, final String firstname, final String surname,
			final String login, final String dashboard, final String library, final String category,
