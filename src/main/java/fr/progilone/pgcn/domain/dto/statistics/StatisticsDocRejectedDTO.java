...
public class StatisticsDocRejectedDTO implements Comparable<StatisticsDocRejectedDTO> {
	...
	static {
		final Ordering<StatisticsDocRejectedDTO> orderLib = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsDocRejectedDTO::getLibraryName);
		final Ordering<StatisticsDocRejectedDTO> orderPj = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsDocRejectedDTO::getProjectName);
		final Ordering<StatisticsDocRejectedDTO> orderLot = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsDocRejectedDTO::getLotLabel);
		final Ordering<StatisticsDocRejectedDTO> orderDate = Ordering.natural()
			.nullsFirst()
			.onResultOf(StatisticsDocRejectedDTO::getImportDate);
