...
public class AuthorizationDTO {
	...
	public AuthorizationDTO(final String identifier, final String code, final String label, final String description,
			final String module, List<String> requirements, List<String> dependencies) {
