...
public class ManualDeliveryDTO extends AbstractDTO {
	...
	public ManualDeliveryDTO(String identifier, SimpleLotDTO lot, String label, String description, String payment,
			String status, String method, LocalDate receptionDate, String folderPath, String imgFormat,
			String digitizingNotes, String controlNotes) {
	...
	public static final class Builder {
		...
		public ManualDeliveryDTO build() {
			return new ManualDeliveryDTO(identifier, lot, label, description, payment, status, method, receptionDate,
					folderPath, imgFormat, digitizingNotes, controlNotes);
		}
