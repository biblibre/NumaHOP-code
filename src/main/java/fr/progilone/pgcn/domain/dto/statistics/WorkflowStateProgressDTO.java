...
public class WorkflowStateProgressDTO implements Comparable<WorkflowStateProgressDTO> {
	...
	static {
		Ordering<WorkflowStateProgressDTO> orderLib = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowStateProgressDTO::getLibraryName);
		Ordering<WorkflowStateProgressDTO> orderWorkflow = Ordering.natural()
			.nullsFirst()
			.onResultOf(WorkflowStateProgressDTO::getWorkflowModelName);
