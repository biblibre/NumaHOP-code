...
public class SimpleLotDTO {
	...
	public SimpleLotDTO(final String identifier, final String code, final String label, final String requiredFormat,
			final SimpleProjectDTO project, final Lot.LotStatus status, final Lot.Type type,
			final boolean filesArchived, final OcrLanguageDTO activeOcrLanguage) {
		super();
		this.label = label;
		this.code = code;
		this.identifier = identifier;
	...
	public static final class Builder {
		...
		public SimpleLotDTO build() {
			return new SimpleLotDTO(identifier, code, label, requiredFormat, project, status, type, filesArchived,
					activeOcrLanguage);
		}
