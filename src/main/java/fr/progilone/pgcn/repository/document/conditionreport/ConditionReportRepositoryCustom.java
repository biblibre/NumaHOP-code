...
public interface ConditionReportRepositoryCustom {
	 ...
	 */
	Page<String> search(List<String> libraries, List<String> projects, List<String> lots, LocalDate from, LocalDate to,
			DimensionFilter dimensions, Map<String, List<String>> bindings, List<String> docIdentifiers,
			boolean toValidateOnly, Pageable pageable);
