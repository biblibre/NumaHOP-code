...
public class TestConverterFactory {
	...
	/**
	 * Retourne un Converter de String en AbstractDomainObject, utilisé pour tester les
	 * contrôleur qui prennent un AbstractDomainObject en paramètre d'une requête GET
	 * @param clazz
	 * @param <T>
	 * @return
	 */
