...
public class MailboxConfigurationControllerTest {
	...
	public void setUp() throws Exception {
		final MailboxConfigurationController controller = new MailboxConfigurationController(
				mailboxConfigurationService, accessHelper, libraryAccesssHelper);
	...
	public void testDelete() throws Exception {
		...
		// test delete
		this.restMockMvc
			.perform(delete("/api/rest/conf_mail/{id}", identifier).contentType(MediaType.APPLICATION_JSON)
				.with(allPermissions))
	...
	public void testFindByLibrary() throws Exception {
		...
		// test findAllActive
		this.restMockMvc
			.perform(get("/api/rest/conf_mail").param("library", cConfigurationMail.getLibrary().getIdentifier())
	...
	public void getById() throws Exception {
		...
		// test ok
		this.restMockMvc
			.perform(get("/api/rest/conf_mail/{id}", cConfigurationMail.getIdentifier())
				.accept(MediaType.APPLICATION_JSON)
				.with(allPermissions))
			.andExpect(status().isOk())
			.andExpect(content().contentType(MediaType.APPLICATION_JSON))
		...
		// test ko
		this.restMockMvc
			.perform(get("/api/rest/conf_mail/{identifier}", cConfigurationMail.getIdentifier())
				.accept(MediaType.APPLICATION_JSON)
				.with(allPermissions))
	...
	public void testUpdate() throws Exception {
		...
		// test update
		this.restMockMvc
			.perform(post("/api/rest/conf_mail/" + identifier).contentType(MediaType.APPLICATION_JSON)
				.content(TestUtil.convertObjectToJsonBytes(cConfigurationMail))
				.with(allPermissions))
			.andExpect(status().isOk())
			.andExpect(content().contentType(MediaType.APPLICATION_JSON))
