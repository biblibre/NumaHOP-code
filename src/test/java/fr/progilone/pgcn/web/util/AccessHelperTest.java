...
public class AccessHelperTest {
	...
	public static final CustomUserDetails USER_PRESTA = new CustomUserDetails("4efbfc73-3af8-4747-b730-8610374acf86",
			"anne", "azerty", Lang.FR, "LIB-001", Collections.emptyList(), false, User.Category.PROVIDER);

	public static final CustomUserDetails USER_TOTO = new CustomUserDetails("199c0268-1b1b-453d-9725-6d9747588477",
			"toto", "azerty", Lang.FR, "LIB-001", Collections.emptyList(), false, User.Category.OTHER);

	public static final CustomUserDetails USER_SUPER = new CustomUserDetails("9503d0dc-014b-413e-ab2f-3521572545fa",
			"superman", "azerty", Lang.FR, "LIB-001", Collections.emptyList(), true, User.Category.OTHER);
	...
	@BeforeEach
	public void setUp() {
		accessHelper = new AccessHelper(bibliographicRecordService, deliveryService, digitalDocumentService,
				docUnitService, lotService, projectService, trainService, userService, conditionReportDetailService);
	...
	public void testFilterProjects() {
		final List<String> identifiers = Arrays.asList("e00d7033-1935-4f21-b825-91fec1ec3067",
				"6c2aa430-e67d-4b8a-800f-352a754498ae", "c0d6edc7-6e5d-4100-9b36-eb295a63cfa9");
	...
	private void setUser(final CustomUserDetails userDetails) {
		final TestingAuthenticationToken authenticationToken = new TestingAuthenticationToken(userDetails,
				"credentials");
