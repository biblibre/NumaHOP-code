...
public class BibliographicRecordServiceTest {
	...
	@BeforeEach
	public void setUp() {
		service = new BibliographicRecordService(bibliographicRecordRepository, esDocUnitService, docPropertyService,
	...
	public void testMassUpdate() {
		...
		propertyUpd
			.setValue("Le Petit Prince est une œuvre de langue française, la plus connue d'Antoine de Saint-Exupéry.");
		...
		when(bibliographicRecordRepository.findAllById(updates.getRecordIds()))
