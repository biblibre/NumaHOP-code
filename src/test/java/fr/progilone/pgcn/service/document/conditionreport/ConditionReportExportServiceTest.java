...
public class ConditionReportExportServiceTest {
	...
	@BeforeEach
	public void setUp() {
		service = new ConditionReportExportService(descBindingPropertyService, descriptionValueService, docUnitService,
				messageService, propertyConfigurationService);
	...
	public void testWriteReportTemplate() throws IOException {
		final List<String> identifiers = Arrays.asList("1495f953-bdac-4742-8a2b-18944c677caf",
				"bc3f9cab-8cdb-40b4-b343-002619d0732e");
