...
public class BinaryManagerTest {
    ...
    public void generateDerivedThumbnailForMaster() throws IOException, InterruptedException, ExecutionException {
        ...
        when(imageDispatcherService.createThumbnailDerived(any(String.class),
                                                           any(File.class),
                                                           any(File.class),
                                                           any(ViewsFormatConfiguration.FileFormat.class),
                                                           any(ViewsFormatConfiguration.class),
                                                           any(Long[].class))).then(i -> {
                                                               ImageUtils.createThumbnail((File) i.getArguments()[1],
        ...
        final StoredFile master = bm.createFromFileForPage(page1, filePage1, StoredFileType.MASTER, ViewsFormatConfiguration.FileFormat.MASTER, Optional.empty(), FAKE_LIB_ID);
        // Check from storedFile
        ...
        CompletableFuture<Void> runAsync = CompletableFuture.runAsync(() -> bm.generateDerivedThumbnailForMaster(master,
                                                                                                                 ...
                                                                                                                 0,
                                                                                                                 null,
                                                                                                                 FAKE_LIB_ID), executorService);
        runAsync.get();
        runAsync = CompletableFuture.runAsync(() -> bm.generateDerivedThumbnailForMaster(master,
                                                                                         page1,
    ...
    public void deleteFileFromStoredFile() {
        ...
        when(formatConfigurationService.getOneByLot(any(String.class))).thenReturn(getValidFormatConfiguration());
        final StoredFile storedPage1 = bm.createFromFileForPage(page1,
                                                                fileDerived1,
                                                                StoredFileType.DERIVED,
                                                                ViewsFormatConfiguration.FileFormat.VIEW,
                                                                Optional.empty(),
                                                                FAKE_LIB_ID);
    ...
    public void deleteAllFilesFromPage() throws IOException {
        ...
        when(formatConfigurationService.getOneByLot(any(String.class))).thenReturn(getValidFormatConfiguration());
        final StoredFile storedPage1Derived1 = bm.createFromFileForPage(page1,
                                                                        fileDerived1,
                                                                        StoredFileType.DERIVED,
                                                                        ViewsFormatConfiguration.FileFormat.VIEW,
                                                                        Optional.empty(),
                                                                        FAKE_LIB_ID);
        final StoredFile storedPage1Derived2 = bm.createFromFileForPage(page1,
                                                                        fileDerived2,
                                                                        StoredFileType.DERIVED,
                                                                        ViewsFormatConfiguration.FileFormat.VIEW,
                                                                        Optional.empty(),
