...
public class LockServiceTest {
	...
	public void testAcquireLock_ShouldThrowException_whenExistingNonExpiredLockOnEntityForAnotherUser() {
		...
		final CustomUserDetails userDetails = new CustomUserDetails("4efbfc73-3af8-4747-b730-8610374acf86", "user",
				"azerty", Lang.FR, "LIB-001", Collections.emptyList(), false, User.Category.PROVIDER);
	...
	@Test
	public void testAcquireLock_ShouldAcquireLockAndRemoveExpiredLockifPresent_whenExistingExpiredLockOnEntity()
	...
	@Test
	public void testCheckLock_ShouldThrowException_whenExistingNonExpiredLockOnEntityForAnotherUser()
			throws PgcnLockException {
	...
	@Test
	public void testCheckLock_ShouldNotThrowException_whenExistingExpiredLockOnEntityForAnotherUser()
			throws PgcnLockException {
		final CustomUserDetails userDetails = new CustomUserDetails("4efbfc73-3af8-4747-b730-8610374acf86", "user",
				"azerty", Lang.FR, "LIB-001", Collections.emptyList(), false, User.Category.PROVIDER);
		final TestingAuthenticationToken authenticationToken = new TestingAuthenticationToken(userDetails,
	...
	@Test
	public void testCheckLock_ShouldNotThrowException_whenExistingExpiredLockOnEntityForCurrentUser()
			throws PgcnLockException {
		final CustomUserDetails userDetails = new CustomUserDetails("4efbfc73-3af8-4747-b730-8610374acf86", "user",
				"azerty", Lang.FR, "LIB-001", Collections.emptyList(), false, User.Category.PROVIDER);
		final TestingAuthenticationToken authenticationToken = new TestingAuthenticationToken(userDetails,
