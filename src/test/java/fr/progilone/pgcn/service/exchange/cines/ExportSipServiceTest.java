...
public class ExportSipServiceTest {
	...
	@BeforeEach
	public void setUp() {
		service = new ExportSipService(languageCodeService, cinesLanguageCodeService, libraryParameterService,
				docUnitRepository, fm);
	...
	public void testWriteMetadata()
			throws JAXBException, IOException, SAXException, PgcnTechnicalException, ExportCinesException {
	...
	@Disabled
	@Test
	public void testWriteEmptyServiceVersant()
			throws JAXBException, IOException, SAXException, PgcnTechnicalException, ExportCinesException {
		try (final OutputStream out = new ByteArrayOutputStream();
				final OutputStream bufOut = new BufferedOutputStream(out)) {
			final BibliographicRecordDcDTO dcDto = getRecordDto();
	...
	@Disabled
	@Test
	public void assertDefaultValuesAreSet()
			throws JAXBException, IOException, SAXException, PgcnTechnicalException, ExportCinesException {
		try (final OutputStream out = new ByteArrayOutputStream();
				final OutputStream bufOut = new BufferedOutputStream(out)) {
			final BibliographicRecordDcDTO dcDto = getRecordDto();
			...
			final DocUnit docUnit = GenerateDocUnitUtil
				.getDocUnit(GenerateDocUnitUtilEnum.NON_COMPLIANT_AUTHOR_PUBLISHER);
