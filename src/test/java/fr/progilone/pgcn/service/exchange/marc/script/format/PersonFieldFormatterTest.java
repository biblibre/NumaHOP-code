...
public class PersonFieldFormatterTest extends AbstractScriptTest {
	...
	private Record buildRecord(final String data_a, final String data_b, final String data_c, final String data_f,
			final String data_d, final String data_D, final String data_4) {
	...
	public void testGroovy2() throws ScriptException {
		...
		final Map<String, Object> bindings = new HashMap<>();
		bindings.put("marc_702", fld702);
		final Object actual = evalUserScript(expression, configuration, bindings,
				new PersonFieldFormatter("test", null));
