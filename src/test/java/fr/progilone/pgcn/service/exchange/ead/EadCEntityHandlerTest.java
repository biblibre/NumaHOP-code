...
public class EadCEntityHandlerTest {
	...
	public void test() throws IOException, JAXBException, ParserConfigurationException, SAXException {
		final String xml = "<toto>" + "<c id=\"toplevel-001\">" + "<c id=\"sublevel-001-a\"></c>"
				+ "<c id=\"sublevel-001-b\"></c>" + "</c>" + "<c id=\"toplevel-002\">" + "<c id=\"sublevel-002-a\"></c>"
				+ "</c>" + "</toto>";
		final File tmpFile = new File(FileUtils.getTempDirectory(),
				"EadCEntityHandlerTest_test_" + System.currentTimeMillis() + ".xml");
