...
public class TestScriptEngine {
	...
	/*
	 * Résultats pour 1000 # Java durée exécution: 26 # Javascript (avec compilation)
	 * durée compilation: 300 durée exécution: 4156 # Groovy (sans compilation) durée
	 * exécution: 111 # Groovy (avec compilation) durée compilation: 18 durée exécution:
	 * 106 # Groovy (GroovyScriptEngineFactory, avec compilation) durée compilation: 31
	 * durée exécution: 190 # Groovy (eval) durée exécution: 12993 # Groovy (shell) durée
	 * exécution: 8135
	 */
	...
	public void testGroovy30() throws ScriptException {
		...
		final ScriptEngine engine = new GroovyScriptEngineFactory().getScriptEngine(); // identique
																						// à
																						// testGroovy2
