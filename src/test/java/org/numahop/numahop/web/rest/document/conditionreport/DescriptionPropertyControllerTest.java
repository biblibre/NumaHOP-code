...
public class DescriptionPropertyControllerTest {
	...
	public void testCreate() throws Exception {
		...
		// 201
		this.restMockMvc
			.perform(post("/api/rest/condreport_desc_prop").contentType(MediaType.APPLICATION_JSON)
	...
	public void testDelete() throws Exception {
		...
		// 200
		this.restMockMvc
			.perform(delete("/api/rest/condreport_desc_prop/{id}", identifier).contentType(MediaType.APPLICATION_JSON))
	...
	public void testUpdate() throws Exception {
		...
		// 200
		this.restMockMvc
			.perform(post("/api/rest/condreport_desc_prop/{id}", value.getIdentifier())
