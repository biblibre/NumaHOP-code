...
public class Z3950ServerControllerTest {
	...
	public void testCreate() throws Exception {
		...
		this.restZ3950ServerMockMvc
			.perform(post("/api/rest/z3950Server").contentType(MediaType.APPLICATION_JSON)
	...
	public void getById() throws Exception {
		...
		this.restZ3950ServerMockMvc
			.perform(get("/api/rest/z3950Server/{id}", z3950Server.getIdentifier()).accept(MediaType.APPLICATION_JSON))
	...
	public void testGetById_notFound() throws Exception {
		...
		this.restZ3950ServerMockMvc
			.perform(get("/api/rest/z3950Server/{identifier}", identifier).accept(MediaType.APPLICATION_JSON))
	...
	public void testUpdate() throws Exception {
		...
		// test update
		this.restZ3950ServerMockMvc
			.perform(post("/api/rest/z3950Server/" + identifier).contentType(MediaType.APPLICATION_JSON)
	...
	public void testFindAllDTO() throws Exception {
		...
		this.restZ3950ServerMockMvc
			.perform(get("/api/rest/z3950Server").param("dto", "true").accept(MediaType.APPLICATION_JSON))
			.andExpect(status().isOk())
			.andExpect(content().contentType(MediaType.APPLICATION_JSON))
			.andExpect(jsonPath("$[0].identifier").value(servers.get(0).getIdentifier()));
	}
	...
	public void testDelete() throws Exception {
		...
		this.restZ3950ServerMockMvc
			.perform(delete("/api/rest/z3950Server/{id}", identifier).contentType(MediaType.APPLICATION_JSON))
			.andExpect(status().isOk());
