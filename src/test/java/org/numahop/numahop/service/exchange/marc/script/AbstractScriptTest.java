...
import static org.numahop.numahop.service.exchange.marc.MarcMappingEvaluationService.*;
...
public abstract class AbstractScriptTest {
	 ...
	 */
	protected Object evalUserScript(final String statement, final Map<String, Object> userBindings,
	 ...
	 * @throws ScriptException
	 */
	protected Object evalUserScript(final String statement, final String configStatement,
			final Map<String, Object> userBindings, final CustomScript customScript) throws ScriptException {
