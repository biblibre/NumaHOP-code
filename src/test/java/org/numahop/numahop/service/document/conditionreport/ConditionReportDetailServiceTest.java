...
import static org.numahop.numahop.exception.message.PgcnErrorCode.CONDREPORT_DETAIL_DESC_EMPTY;
...
public class ConditionReportDetailServiceTest {
	...
	@BeforeEach
	public void setUp() {
		service = new ConditionReportDetailService(conditionReportDetailRepository, propertyConfigurationService,
				userService);
	...
	public void testCreate2() {
		...
		when(conditionReportDetailRepository.findByIdentifier(detailId))
			.then(invocation -> saveAnswer.getDomainObject());
		when(conditionReportDetailRepository.getMaxPositionByConditionReportIdentifier(report.getIdentifier()))
			.thenReturn(3);
	...
	public void testFindByConditionReport() {
		...
		when(conditionReportDetailRepository.findByConditionReportIdentifier(detail.getIdentifier()))
			.thenReturn(details);
	...
	public void testDelete() {
		...
		when(conditionReportDetailRepository.findByConditionReportIdentifier(detail.getReport().getIdentifier()))
			.thenReturn(Collections.singletonList(otherDetail));
